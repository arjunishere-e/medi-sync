...
import NursePatientsOverview from '../Components/dashboard/NursePatientsOverview.js';
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">
                    {user?.role === 'nurse' ? 'Nurse Rounds Overview' : 'Patients Overview'}
                  </CardTitle>
                  <Link to="/patients">
